...
<body 
                ...
                <div class="flex items-center space-x-5">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-2 text-sm text-slate-600 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            ...
                            <form hx-post="/logout" hx-include="#csrf-holder [name=_token]" hx-trigger="click" class="cursor-pointer">
    ...
    @include('layouts.components.global-toast')
